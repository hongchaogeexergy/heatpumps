...
class HeatPumpCascadeIHXEconTrans(HeatPumpCascadeBase):
    """Two stage transcritical cascading heat pump with two refrigerants + internal heat exchanger and
    open or closed economizer pro cycle."""
    ...
    def generate_connections(self):
        ...
        self.conns['A10'] = Connection(
            self.comps['HT_comp2'], 'out1', self.comps['trans'], 'in1', 'A10'
        )
