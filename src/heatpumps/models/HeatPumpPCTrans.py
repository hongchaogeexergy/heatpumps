...
from tespy.components import (Compressor, CycleCloser, DropletSeparator,
                              HeatExchanger, Merge, Pump, SimpleHeatExchanger,
                              Sink, Source, Splitter, Valve, PowerSource, PowerBus, Motor)
...
class HeatPumpPCTrans(HeatPumpBase):
    ...
    def generate_connections(self):
        ...
        self.conns['A7'] = Connection(
            self.comps['merge'], 'out1', self.comps['trans'], 'in1', 'A7'
            )
